...
const testimonials = [
    ...
    },
    {
        id: 5,
        name: 'Budi Santoso',
        comment: 'Rangga membantu saya mendapatkan penawaran terbaik untuk mobil impian saya. Proses pembelian sangat lancar.',
    },
    {
        id: 6,
        name: 'Dewi Anggraini',
        comment: 'Pelayanan after-sales dari Rangga luar biasa. Dia selalu siap membantu bahkan setelah pembelian selesai.',
    },
    {
        id: 7,
        name: 'Hendra Wijaya',
        comment: 'Rangga sangat knowledgeable tentang berbagai model Toyota. Dia membantu saya membuat keputusan yang tepat.',
    },
    {
        id: 8,
        name: 'Rina Fitriani',
        comment: 'Saya sangat merekomendasikan Rangga kepada siapa pun yang ingin membeli mobil Toyota. Pelayanan terbaik!',
    }
]
