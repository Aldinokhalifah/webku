                ...
                <form className="space-y-6" action="#">
                    ...
                    <div>
                        ...
                        <div>
                            ...
                            <input type="text" name="fullname" id="fullname" placeholder="name" className="bg-gray-50 border border-gray-300 text-gray-900 sm:text-sm rounded-lg focus:ring-indigo-500 focus:border-indigo-500 block w-full p-2.5 dark:bg-gray-600 dark:border-gray-500 dark:placeholder-gray-400 dark:text-white" required/>
                        </div>
                            <div className="flex items-start">
                                ...
                                <button type="submit" formAction={'/'} className="w-full text-white bg-indigo-700 hover:bg-indigo-800 focus:ring-4 focus:ring-indigo-300 font-medium rounded-lg text-sm px-5 py-2.5 text-center dark:bg-indigo-600 dark:hover:bg-indigo-700 dark:focus:ring-indigo-800">Sign up to your account</button>
                                <div className="text-sm font-medium text-gray-500 dark:text-gray-300">
                                    Have registered? <Link href="/login" className="text-indigo-700 hover:underline dark:text-indigo-500">Sign In Here</Link>
                                </div>
                </form>
            </div>
        </div>
