...
export default function Hero() {
    ...
    return (
        <section id="tentang" className="py-12 md:py-20 text-white bg-gradient-to-r from-sky-900 to-cyan-700">
            <div className="container mx-auto px-4">
                <div className="max-w-3xl mx-auto text-center" data-aos="fade-up">
                    <h1 className="text-3xl md:text-4xl font-bold mb-4">Sales Mobil Profesional</h1>
